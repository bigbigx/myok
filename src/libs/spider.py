...
class  yunSpider(object):
    ...
    def RDS(self):
        ...
        for info in response.get('Items').get('DBInstance'):
            ...
            result['ReadOnlyDBInstanceIds'] = info.get('ReadOnlyDBInstanceIds').get('ReadOnlyDBInstanceId')
    ...
    def ECS(self):
        ...
        for info in info_list:
            result = {}
            result['InnerIpAddress'] = "".join(info.get('InnerIpAddress').get('IpAddress'))
            ...
            result['SecurityGroupIds'] = info.get('SecurityGroupIds').get('SecurityGroupId')
            ...
            result['InstanceNetworkType'] = info.get('InstanceNetworkType')
            result['PublicIpAddress'] = "".join(info.get('PublicIpAddress').get('IpAddress'))
            ...
            result['OperationLocks'] = info.get('OperationLocks').get('LockReason')
